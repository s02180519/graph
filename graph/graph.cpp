...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))     
    {
        ...
        glBindTexture(GL_TEXTURE_2D, textureCoal);
       ...
       // glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        ...
        GLint projectionLoc = glGetUniformLocation(Square.Program, "projection");
        ...
        GLfloat blueValue = (sin(glfwGetTime()) / 2) + 0.5f;
        GLint vertexColorLocation = glGetUniformLocation(Square.Program, "ourColor");
